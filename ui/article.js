                    ...
                    content += `
                        <div class="comment">
                            <p style="color:#550C73">${escapeHTML(commentsData[i].comment)}</p>
                                <div class="commenter">
                                    <div style='color:#00a087;font-weight:italic;font-variant: small-caps'>${escapeHTML(commentsData[i].username)}
                                    </div> - ${time.toLocaleTimeString()} on ${time.toLocaleDateString()}
                                    <hr/>
                                </div>
                        </div>`;
                }
